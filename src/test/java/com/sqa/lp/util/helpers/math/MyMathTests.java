...
// Object[][] data = { { 2.0, 2.0, 4.0 }, { 5.0, 2.0, 25.0 }, { 4.0, 3.0, 64.0
/// }, { 1.0, 0.0, 1.0 },
...
// String message = String.format("The result of %.0f divided by %.0f is %.0f ",
...
// public void testPowerNumbers(double number, double power, double
/// expectedResult) {
// double actualResult = MyMath.powerNumber(number, power);
// String message = String.format("The result of %.0f to the power of %.0f is
/// %.0f ", number, power, actualResult);
//
// System.out.println(message);
// assertEquals(expectedResult, actualResult, 0, message);
// }
